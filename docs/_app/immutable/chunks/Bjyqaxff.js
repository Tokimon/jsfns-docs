...
`,typesMarkdown:``}]},{name:`debounce`,functions:[{definition:`<pre><code class="hljs language-ts"><span class="hljs-title function_">debounce</span>&lt;<span class="hljs-title class_">Textends</span> <span class="hljs-title class_" data-custom-type="DebounceCallback">DebounceCallback</span>&gt;(<span class="hljs-attr" title="The function to add debounce to">callback</span>: T, <span class="hljs-attr" title="Number of milliseconds without another call to trigger the last function">ms</span>?: <span class="hljs-built_in">number</span>): <span class="hljs-title class_" data-custom-type="DebouncedFunction">DebouncedFunction</span>&lt;T&gt;
...
`,typesMarkdown:``}]},{name:`isFunction`,functions:[{definition:`<pre><code class="hljs language-ts"><span class="hljs-title function_">isFunction</span>(<span class="hljs-attr" title="Argument to test">x</span>: <span class="hljs-built_in">unknown</span>): <span class="hljs-title function_">boolean</span> (x <span class="hljs-title function_">is</span> (<span class="hljs-attr">args</span>: <span class="hljs-built_in">unknown</span>[]) =&gt; <span class="hljs-built_in">unknown</span>)
...
`,typesMarkdown:``}]},{name:`kebabCase`,functions:[{definition:'<pre><code class="hljs language-ts"><span class="hljs-title function_">kebabCase</span>(<span class="hljs-attr" title="String to transform">str</span>: <span class="hljs-built_in">string</span>, <span class="hljs-attr" title="Settings to pass to the `phrasify` function">settings</span>?: <span class="hljs-title class_" data-custom-type="PhrasifySettings">PhrasifySettings</span>): <span class="hljs-built_in">string</span>\n</code></pre>',comment:`<p>Transform phrase into a dashed phrase<br>(eg. &#39;camelCase&#39; -&gt; &#39;camel-case&#39; or &#39;spaced phrase&#39; -&gt; &#39;spaced-phrase&#39;)</p>
...
`,typesMarkdown:``}]},{name:`phrasify`,functions:[{definition:`<pre><code class="hljs language-ts"><span class="hljs-title function_">phrasify</span>(<span class="hljs-attr" title="The string to transform">input</span>: <span class="hljs-built_in">string</span>, <span class="hljs-attr" title="The settings for the transform">settings</span>?: <span class="hljs-title class_" data-custom-type="PhrasifySettings">PhrasifySettings</span>): <span class="hljs-built_in">string</span>
...
`,typesMarkdown:``}]},{name:`snakeCase`,functions:[{definition:`<pre><code class="hljs language-ts"><span class="hljs-title function_">snakeCase</span>(<span class="hljs-attr" title="String to transform">str</span>: <span class="hljs-built_in">string</span>, <span class="hljs-attr" title="Settings to pass to the phrasify function">settings</span>?: <span class="hljs-title class_" data-custom-type="PhrasifySettings">PhrasifySettings</span>): <span class="hljs-built_in">string</span>
...
`,typesMarkdown:``}]},{name:`throttle`,functions:[{definition:`<pre><code class="hljs language-ts"><span class="hljs-title function_">throttle</span>&lt;<span class="hljs-title class_">Textends</span> (<span class="hljs-attr">args</span>: <span class="hljs-built_in">unknown</span>[]) =&gt; <span class="hljs-built_in">void</span>&gt;(<span class="hljs-attr" title="The function to throttle">callback</span>: T, <span class="hljs-attr" title="Number of milliseconds before the function can be called again">ms</span>?: <span class="hljs-built_in">number</span>): T
...
</code></pre>`,moduleName:`truncate`}],n={modules:e,customTypes:t};export{t as customTypes,n as default,e as modules};